...
@section('actionBar')
<a href="{{ route('admin.family.download') }}" class="btn btn-outline btn-info pull-right m-l-20 waves-effect waves-light" target="_blank">DOWNLOAD FORMAT</a>
    ...
    <a href="{{ route('admin.family.export_excel') }}" class="btn btn-outline btn-info pull-right m-l-20 waves-effect waves-light" target="_blank">EXPORT EXCEL</a>
...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post" action="/admin/family/import_excel" enctype="multipart/form-data">
