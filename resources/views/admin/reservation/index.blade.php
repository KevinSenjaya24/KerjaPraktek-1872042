...
@section('actionBar')
    <a href="{{ route('admin.reservation.detail','add') }}" class="btn btn-outline btn-info pull-right m-l-20 waves-effect waves-light">Add</a>
@endSection
                    ...
                    <table id="myTable" class="table table-striped">
                        ...
                        @foreach($reservations as $reservation)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.reservation.detail',$reservation->id) }}" class="btn btn-primary editCta" name="edit_id" value="{{$reservation->id}}"><i class="mdi mdi-border-color"></i></a>
