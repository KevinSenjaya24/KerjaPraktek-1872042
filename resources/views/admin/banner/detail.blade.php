...
@section('pageTitle', 'Banner Details Management')
...
<div class="col-sm-8">
    <div class="white-box">
        <h3 class="box-title m-b-0 black">FORM BANNER DETAILS</h3>
        <hr>
        <form action="{{ route('admin.banner.update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" id="judul" value="{{ (isset($banner->name) ? $banner->name : "") }}" aria-describedby="banner" placeholder="Masukan Nama Banner">
            </div>

            <div class="form-group">
                <label for="link">Link</label>
                <input type="text" name="link" class="form-control" id="link" value="{{ (isset($banner->link) ? $banner->link : "") }}" aria-describedby="banner" placeholder="Masukan Link">
            </div>
