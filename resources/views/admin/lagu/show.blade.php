...
@section('pageTitle', 'LAGU DETAILS')
      ...
      <div class="row">
            <div class="col-lg-12 py-3">
                <article class="blog-single-entry">
                    ...
                    <h1 class="post-title" style="color:#2f323e; text-align:center;">{{$detailslagu->judul}}</h1>
                    <div class="entry-meta mb-4 post-title">
                        <div class="meta-item" style="color:#2f323e; text-align:center;">
                            <div class="icon">
                            <span class="mai-pricetags"></span>
                            </div>
                            Category : 
                            {{$detailslagu->category}}
                        </div>
                    </div>
