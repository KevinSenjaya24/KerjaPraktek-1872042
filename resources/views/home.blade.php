                    ...
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            ...
                            @foreach($ultah as $jemaat)
                                <a class="aultah" href="https://api.whatsapp.com/send?phone=62{{$jemaat->no_telp}}"><b>{{$jemaat->nama}},</b></a>
                            @endforeach
                            !
                            <p></p>
                            <b>Mazmur 20:4</b>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="images/banner/SM.JPG" alt="Third slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="images/banner/Pdt.JPG" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="images/banner/GSM.JPG" alt="Third slide">
                </div>
        </div>
            ...
            <div class="col-lg ">
                ...
                <div class="col-lg">
                    <div class="float-sm-left" style="font-family: viga;">
                        <p><a href="/categoryReservation" class="btn btn-primary py-3 booking">Booking</a></p>
                    </div>
                </div>
            </div>
        </div>
