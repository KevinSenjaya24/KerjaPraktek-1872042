...
@section('pageTitle', 'CATEGORY POST MANAGEMENT')

@section('actionBar')
    <a href="{{ route('admin.categoryPost.detail','add') }}" class="btn btn-outline btn-info pull-right m-l-20 waves-effect waves-light">Add</a>
@endSection
    ...
    <div class="panel panel-info">
        <div class="panel-wrapper collapse in" aria-expanded="true">
            <div class="panel-body">
                <h3 class="box-title m-b-0 black">Table Category Post</h3>
                <hr>
                    ...
                    <table id="myTable" class="table table-striped">
                        ...
                        <?php $no++ ;?>
                            <tr>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <a href="{{ route('admin.categoryPost.show',$category->id) }}" name="edit_id" value="{{$category->id}}">
                                    ...
                                    <div class="col-md-2">
                                        <a href="{{ route('admin.categoryPost.detail',$category->id) }}" name="edit_category" value="{{$category->id}}">
                                    ...
                                    <div class="col-md-2">
                                        <form method="POST" action="{{route('admin.categoryPost.delete', $category->id)}}">
                                            @csrf
                                            @method('DELETE')
