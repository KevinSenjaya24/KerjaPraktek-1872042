...
@section('pageTitle', 'LAGU MANAGEMENT')

@section('actionBar')
    <a href="{{ route('admin.lagu.detail','add') }}" class="btn btn-outline btn-info pull-right m-l-20 waves-effect waves-light">Add</a>
@endSection
    ...
    <div class="panel panel-info">
        <div class="panel-wrapper collapse in" aria-expanded="true">
            <div class="panel-body">
                <h3 class="box-title m-b-0 black">Table Lagu</h3>
                <hr>
                    ...
                    <table id="myTable" class="table table-striped">
                        ...
                        <?php $no++ ;?>
                            <tr>
                                ...
                                <td>{{$lagu->judul}}</td>
                                <td>{{$lagu->category}}</td>
                                <td><a href="{{$lagu->link_youtube}}">{{$lagu->link_youtube}}</a></td>
                                <td>
                                <div class="row">
                                    <div class="col-md-2">
                                        <a href="{{ route('admin.lagu.show',$lagu->id) }}" name="edit_category" value="{{$lagu->id}}">
                                    ...
                                    <div class="col-md-2">
                                        <a href="{{ route('admin.lagu.detail',$lagu->id) }}" name="edit_category" value="{{$lagu->id}}">
                                    ...
                                    <div class="col-md-2">
                                        <form method="POST" action="{{route('admin.lagu.delete', $lagu->id)}}">
                                            @csrf
                                            @method('DELETE')
